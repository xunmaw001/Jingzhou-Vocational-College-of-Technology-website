    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="获奖材料" prop="huojiangcailiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="获奖材料"
                  v-model="ruleForm.huojiangcailiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huojiangcailiao" label="获奖材料" prop="huojiangcailiao">
                    <span>{{ruleForm.huojiangcailiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="特色与创新" prop="teseyuchuangxin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.teseyuchuangxin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.teseyuchuangxin" label="特色与创新" prop="teseyuchuangxin">
                    <span v-html="ruleForm.teseyuchuangxin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="师生获奖情况" prop="shishenghuojiangqingkuang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shishenghuojiangqingkuang" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shishenghuojiangqingkuang" label="师生获奖情况" prop="shishenghuojiangqingkuang">
                    <span v-html="ruleForm.shishenghuojiangqingkuang"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	huojiangcailiao : false,
	fabushijian : false,
	zhuanyejieshao : false,
	teseyuchuangxin : false,
	shishenghuojiangqingkuang : false,
      },
      ruleForm: {
        biaoti: '',
        fengmiantupian: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmiantupian = true;
          ...
          if(o=='huojiangcailiao'){
            this.ruleForm.huojiangcailiao = obj[o];
	    this.ro.huojiangcailiao = true;
            continue;
          }
          if(o=='fabushijian'){
	    ...
	    this.ro.zhuanyejieshao = true;
          ...
          if(o=='teseyuchuangxin'){
            this.ruleForm.teseyuchuangxin = obj[o];
	    this.ro.teseyuchuangxin = true;
            continue;
          }
          if(o=='shishenghuojiangqingkuang'){
            this.ruleForm.shishenghuojiangqingkuang = obj[o];
	    this.ro.shishenghuojiangqingkuang = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.zhuanyejieshao = this.ruleForm.zhuanyejieshao.replace(reg,'../../../ssm8wat2/upload');
	this.ruleForm.teseyuchuangxin = this.ruleForm.teseyuchuangxin.replace(reg,'../../../ssm8wat2/upload');
	this.ruleForm.shishenghuojiangqingkuang = this.ruleForm.shishenghuojiangqingkuang.replace(reg,'../../../ssm8wat2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `pinpaizhuanye/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.pinpaizhuanyeCrossAddOrUpdateFlag = false;
                  this.parent.search();
