<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招聘会名称" prop="zhaopinhuimingcheng">
          <el-input v-model="ruleForm.zhaopinhuimingcheng" 
              placeholder="招聘会名称" clearable  :readonly="ro.zhaopinhuimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招聘会名称" prop="zhaopinhuimingcheng">
              <el-input v-model="ruleForm.zhaopinhuimingcheng" 
                placeholder="招聘会名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招聘会类型" prop="zhaopinhuileixing">
          <el-input v-model="ruleForm.zhaopinhuileixing" 
              placeholder="招聘会类型" clearable  :readonly="ro.zhaopinhuileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招聘会类型" prop="zhaopinhuileixing">
              <el-input v-model="ruleForm.zhaopinhuileixing" 
                placeholder="招聘会类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举办城市" prop="jubanchengshi">
          <el-input v-model="ruleForm.jubanchengshi" 
              placeholder="举办城市" clearable  :readonly="ro.jubanchengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="举办城市" prop="jubanchengshi">
              <el-input v-model="ruleForm.jubanchengshi" 
                placeholder="举办城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举办地址" prop="jubandizhi">
          <el-input v-model="ruleForm.jubandizhi" 
              placeholder="举办地址" clearable  :readonly="ro.jubandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="举办地址" prop="jubandizhi">
              <el-input v-model="ruleForm.jubandizhi" 
                placeholder="举办地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	zhaopinhuimingcheng : false,
	leixing : false,
	fengmiantupian : false,
	neirong : false,
	zhaopinhuileixing : false,
	jubanchengshi : false,
	jubandizhi : false,
	fabushijian : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhaopinhuimingcheng'){
            this.ruleForm.zhaopinhuimingcheng = obj[o];
	    this.ro.zhaopinhuimingcheng = true;
            continue;
          }
          if(o=='leixing'){
	    ...
	    this.ro.neirong = true;
          ...
          if(o=='zhaopinhuileixing'){
            this.ruleForm.zhaopinhuileixing = obj[o];
	    this.ro.zhaopinhuileixing = true;
            continue;
          }
          if(o=='jubanchengshi'){
            this.ruleForm.jubanchengshi = obj[o];
	    this.ro.jubanchengshi = true;
            continue;
          }
          if(o=='jubandizhi'){
            this.ruleForm.jubandizhi = obj[o];
	    this.ro.jubandizhi = true;
            continue;
          }
          if(o=='fabushijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.leixingOptions = "招聘会,宣传会".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssm8wat2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
